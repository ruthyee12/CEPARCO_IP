...
first_history:
	...
	MOVQ XMM3, [R11]
	VPBROADCASTB YMM3, XMM3 ; ymm3 filled with segmentation_map default value

L1:
	CMP RAX, RCX
	JG FINIS

	; result = abs(image_data - historyImage)
	VMOVDQU YMM0, [R9]
	VMOVDQU YMM1, [R10]
	VPSUBB YMM1, YMM0
	VPABSB YMM1, YMM1
