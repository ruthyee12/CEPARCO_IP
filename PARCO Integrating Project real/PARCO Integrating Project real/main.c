...
int main(int argc, char** argv) {
    ...
    system("rmdir bg_subtracted /s /q");
    system("mkdir gray_pgm");
    system("mkdir bg_subtracted");
    ...
    system("ffmpeg -framerate 5 -i \"bg_subtracted/processed_grayframe_%04d.pgm\" -c:v libx264 -pix_fmt yuv420p output_bgsub_sequential.mp4");
    ...
    printf("\n\nAvg Time for C: %llf milliseconds\n", avg_time);
    printf("Total Time for C: %llf milliseconds\n", total_time);
